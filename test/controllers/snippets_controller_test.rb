...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { abstract: @snippet.abstract, description: @snippet.description, lang: @snippet.lang } }
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { abstract: @snippet.abstract, description: @snippet.description, lang: @snippet.lang } }
